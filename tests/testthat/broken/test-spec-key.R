...
test_that("unique keys can be specified", {
  ...
  expect_render(
    uk_spec("foo", type = "btree"),
    "UNIQUE KEY USING BTREE (`foo`)"
  )
  expect_render(
    uk_spec("foo", constr_name = "bar"),
    "CONSTRAINT `bar` UNIQUE KEY (`foo`)"
  )
  expect_render(
    uk_spec("foo", constr_name = "b`ar"),
    "CONSTRAINT `b``ar` UNIQUE KEY (`foo`)"
  )
  expect_render(
    uk_spec("foo", block_size = 4L),
    "UNIQUE KEY (`foo`) KEY_BLOCK_SIZE = 4"
  )
  expect_render(
    uk_spec("foo", comment = "foobar"),
    "UNIQUE KEY (`foo`) COMMENT 'foobar'"
  )
  expect_render(
    uk_spec("foo", comment = "fo`obar"),
    "UNIQUE KEY (`foo`) COMMENT 'fo`obar'"
  )
  expect_render(
    uk_spec("foo", comment = "fo\nobar"),
  ...
  expect_render(
    uk_spec("foo", "bar", "baz", comment = "foobar"),
...
test_that("secondary keys can be specified", {
  ...
  expect_render(
    key_spec("foo", type = "btree"),
    "KEY USING BTREE (`foo`)"
  )
  expect_render(
    key_spec("foo", block_size = 4L),
    "KEY (`foo`) KEY_BLOCK_SIZE = 4"
  )
  expect_render(
    key_spec("foo", comment = "foobar"),
    "KEY (`foo`) COMMENT 'foobar'"
  )
  expect_render(
    key_spec("foo", comment = "fo`obar"),
    "KEY (`foo`) COMMENT 'fo`obar'"
  )
  expect_render(
    key_spec("foo", comment = "fo\nobar"),
    "KEY (`foo`) COMMENT 'fo\\nobar'"
  )
  expect_render(
    key_spec("foo", comment = "fo'obar"),
  ...
  expect_render(
    key_spec("foo", "bar", comment = "foobar"),
...
test_that("fulltext keys can be specified", {
  ...
  expect_render(
    ft_key_spec("foo", parser = "bar"),
    "FULLTEXT KEY (`foo`) WITH PARSER bar"
  )
  expect_render(
    ft_key_spec("foo", comment = "foobar"),
    "FULLTEXT KEY (`foo`) COMMENT 'foobar'"
  )
  expect_render(
    ft_key_spec("foo", comment = "fo`obar"),
    "FULLTEXT KEY (`foo`) COMMENT 'fo`obar'"
  )
  expect_render(
    ft_key_spec("foo", comment = "fo\nobar"),
  ...
  expect_render(
    ft_key_spec("foo", "bar", comment = "foobar"),
    "FULLTEXT KEY `bar` (`foo`) COMMENT 'foobar'"
  )
  expect_render(
    ft_key_spec("foo", "bar", "baz", "foobar"),
...
test_that("spatial keys can be specified", {
  ...
  expect_render(
    spat_key_spec("foo`bar"),
    "SPATIAL KEY (`foo``bar`)"
  )
  expect_render(
    spat_key_spec("foo", comment = "foobar"),
    "SPATIAL KEY (`foo`) COMMENT 'foobar'"
  )
  expect_render(
    spat_key_spec("foo", comment = "fo`obar"),
    "SPATIAL KEY (`foo`) COMMENT 'fo`obar'"
  )
  expect_render(
    spat_key_spec("foo", comment = "fo\nobar"),
  ...
  expect_render(
    spat_key_spec("foo", "bar", comment = "foobar"),
