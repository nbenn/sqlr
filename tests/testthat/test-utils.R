...
test_that("argument checking works for integer", {
  ...
  expect_true(is_int(integer(), n_elem = eq(0)))
  ...
  expect_false(is_int(1L, n_elem = eq(2)))
  expect_true(is_int(c(1L, 2L), n_elem = eq(2)))
  expect_false(is_int(c(1L, 2L), n_elem = gt(2)))
})
...
test_that("argument checking works for logical", {
  ...
  expect_true(is_lgl(logical(), n_elem = eq(0)))
  ...
  expect_false(is_lgl(TRUE, n_elem = eq(2)))
  expect_true(is_lgl(c(TRUE, TRUE), n_elem = eq(2)))
  expect_false(is_lgl(c(TRUE, TRUE), n_elem = gt(2)))
})
...
test_that("argument checking works for character", {
  ...
  expect_true(is_chr("ab", n_char = gte(2)))
  expect_false(is_chr("a", n_char = gte(2)))
  expect_false(is_chr("a", n_char = gt(1)))
  expect_false(is_chr("ab", n_char = lt(1)))
  expect_true(is_chr("ab", n_char = lte(2)))
  expect_false(is_chr("a", n_elem = eq(2)))
  expect_true(is_chr(c("a", "b"), n_elem = eq(2)))
  expect_false(is_chr(c("a", "b"), n_elem = gt(2)))
})
